          ...
          <div>
            ...
            <div className="mb-3 relative">
              <input
                ...
                className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all font-cairo"
              />
            ...
            {/* عدد النتائج */}
            {searchQuery.trim() && (
              <div className="mb-2 text-sm text-gray-600 font-cairo">
                تم العثور على <span className="font-semibold text-green-700">{filteredBooks.length}</span> كتاب
              </div>
            )}

            {/* قائمة الكتب */}
            <div className="max-h-80 overflow-auto border border-gray-200 rounded-lg divide-y">
              {filteredBooks.length === 0 ? (
                <div className="p-8 text-center text-gray-500 font-cairo">
                  <svg
                  ...
                  <p className="text-sm mt-1">لم يتم العثور على أي كتاب يطابق البحث</p>
                </div>
              ) : (
                filteredBooks.map((b) => (
                <label
